...
class ObjectSegmenter:
    def __init__(self, detector_id="IDEA-Research/grounding-dino-tiny", segmenter_id="facebook/sam-vit-base", device="cpu"):
    ...
    def segment(self, image: Image.Image, keyword: str, score_threshold: float = 0.6, box_threshold: float = 0.5, text_threshold: float = 0.3, resolution: int = 1024) -> np.ndarray:
        ...
        best_box = max(results[0]["boxes"], key=lambda b: b[3]).tolist()
        input_box = [[first_box[0], first_box[1]], [first_box[2], first_box[3]]]  
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sam_model", type=str, default="facebook/sam-vit-base", help="SAM model to use")
