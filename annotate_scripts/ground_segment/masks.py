...
def batch_segment_images(input_folder, output_folder):
    ...
    # keywords = [
    #     "floor", "flat surface", "walkway", "loading area",
    #     "aisle", "ground pathway", "warehouse aisle floor",
    #     "industrial corridor", "warehouse corridor floor"
    # ]
    
    keywords = [
        "warehouse floor", "epoxy floor", "ground", "floor", "factory floor",
        "flat industrial floor", "walkway", "ground pathway", 
        "warehouse corridor floor", "aisle floor", "pathway" 
    ]
...
if __name__ == "__main__":
    ...
    output_folder = "/home/abhi/peer/floor_updated"
